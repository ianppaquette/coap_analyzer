...
========================================
Zeek Package Documentation: coap Protocol Analyzer
========================================
...
If the plugin is explicitly loaded (:code:`@load Local/coap_analyzer`), the load process continues:

5. :doc:`Local/coap_analyzer/__load__.zeek </scripts/Local/coap_analyzer/__load__.zeek>` then loads the rest of the scripts.
