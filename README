Zeek Package for coap Protocol Analyzer
================================================

.. image:: https://travis-ci.com/ianppaquette@gmail.com/coap_analyzer.svg?branch=master
   :target: https://travis-ci.com/ianppaquette@gmail.com/coap_analyzer
   :alt: Build Status

.. image:: https://coveralls.io/repos/github/ianppaquette@gmail.com/coap_analyzer/badge.svg?branch=master
   :target: https://coveralls.io/repos/github/ianppaquette@gmail.com/coap_analyzer?branch=master
   :alt: Coverage Status


.. image:: https://img.shields.io/github/license/ianppaquette@gmail.com/coap_analyzer)
...
coap Protocol Analyzer for Zeek
...
```
zkg install https://github.com/ianppaquette@gmail.com/coap_analyzer
```
